...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        view.changeReservationTable(1001, new Date(), 9, "Станислав");
        view.changeReservationTable(1002, new Date(), 1, "Станис");
        view.changeReservationTable(1001, new Date(), 1, "Констанис");
    }
}
